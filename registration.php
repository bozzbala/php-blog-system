    ...
    <form method="post" action="registration.php">
        <div class="auth">
            ...
            <div class="auth-group">
                ...
                <input class=auth-control" type="email" placeholder="Почта" name="email" id="email" maxlength="50" required/>
            ...
            <div class="auth-group">
                ...
                <input class=auth-control" type="text   " placeholder="Ваше полное имя" name="name" id="name" maxlength="50" required/>
            </div>
            <div class="auth-group">
